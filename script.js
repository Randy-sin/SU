...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function generateContent(page) {
        switch(page) {
            case 'home':
                return '<h2>歡迎來到 Champions！候選內閣</h2>' +
                    '<p>我們是一群充滿熱情和理想的學生，致力於為體同學提供優質的服務，促進校園文化建設，豐富學生生活。</p>' +
            ...
            case 'events':
                ...
                <div class="event-list">
                    ...
                    <div class="event-card">
                        ...
                        <ul>
                            <li>上課前：宣傳、派發宣傳物資、廣播介紹午息活動。</li>
                            <li>午息：舉辦午間旋律」，可以邀請老師或者同學，可以點歌亦可以坐着聽歌、聊天。如果有同學有興趣可以上去唱歌，一起帶動氣氛。同時同時進行random dance隨機舞蹈。在SAC可以獲得「Champions!免費即影即有體驗」、派發宣傳品、發布寶遊戲的線索與點信息。</li>
                    ...
                    <div class="event-card">
                        ...
                        <ul>
                            ...
                            <li>午息：在canteen進行random dance隨機舞蹈，邀請舞社的同學前來表演。</li>
                            <li>放學後：在學校門口宣傳，follow IG，發放宣傳物品（糖）。</li>
                        </ul>
                    </div>
                    <div class="event-card">
            ...
            case 'school-affairs':
                return '<h2><i class="fas fa-school"></i> 校內事務</h2>' +
                    ...
                    '<li style="margin-bottom: 0.75em;">歌唱比賽</li>' +
                    '</ol>' +
